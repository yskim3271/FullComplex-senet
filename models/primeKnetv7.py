...
class DS_DDB(nn.Module):
    def __init__(self, dense_channel, depth=4):
        ...
        self.expand_conv = nn.Sequential(
            nn.Conv2d(dense_channel, dense_channel*5, kernel_size=1, padding=0, stride=1, groups=1, bias=False),
            nn.InstanceNorm2d(dense_channel*5, affine=True),
            nn.PReLU(dense_channel*5)
        )
...
class PrimeKnetv7(nn.Module):
    def __init__(self, 
        ...
        super(PrimeKnetv7, self).__init__()
